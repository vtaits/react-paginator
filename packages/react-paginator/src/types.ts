...
import type { BREAK, PAGES } from "./constants";
...
export type BreakComponent<Payload> = ComponentType<
	BreakComponentProps<Payload>
>;
...
export type ContainerComponent<Payload> = ComponentType<
	ContainerComponentProps<Payload>
>;
...
export type PageLinkGroupComponent<Payload> = ComponentType<
	PageLinkGroupProps<Payload>
>;
...
export type StylingNextLinkComponentProps<Payload> = LinkInnerProps & {
	$isDisabled?: boolean;
	$rootProps: RootProps<Payload>;
	children?: ReactNode;
};
...
export type StylingPreviousLinkComponentProps<Payload> = LinkInnerProps & {
	$isDisabled?: boolean;
	$rootProps: RootProps<Payload>;
	children?: ReactNode;
};
...
export type PreviousLinkComponent<Payload> = ComponentType<
	PreviousLinkProps<Payload>
>;

export type StylingPageLinkComponentProps<Payload> = LinkInnerProps & {
	$isCurrent?: boolean;
	$rootProps: RootProps<Payload>;
	children?: ReactNode;
};
...
export type Styles<Payload> = Partial<{
	[Key in keyof StylesParams<Payload>]: GetComponentStyle<
		StylesParams<Payload>[Key]
	>;
}>;
